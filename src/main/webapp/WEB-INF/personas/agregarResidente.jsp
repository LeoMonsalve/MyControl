		...
		<div class="container-fluid col-md-4">
			...
			<div class="col-lg-12 well">
				<form action="">
					...
					<div class="col-lg-12 form-group">
						<label></label> <input type="text" placeholder="Rut"
							class="form-control">
					</div>
					<div class="col-lg-12 form-group">
						<label></label> <input type="text" placeholder="Departamento"
							class="form-control">
					</div>
					<div class="col-lg-12 form-group">
						<label></label> <input type="text"
							placeholder="propietario/arrendatario" class="form-control">
					</div>

					<button type="button" class="btn btn-lg btn-info">Agregar</button>
				</form>
			</div>
			<form action=""></form>
		</div>
