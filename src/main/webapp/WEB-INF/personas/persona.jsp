				...
				<div class="col-lg-12">
					...
					<div class="row">
						<div class="col-lg-6 form-group">
							<label>Nombre Residente</label> <input type="text" placeholder=""
								class="form-control">
						</div>
						<div class="col-lg-6 form-group">
							<label>Tipo Residente</label> <input type="text" placeholder=""
								class="form-control">
						</div>
					</div>
					<div class="row">
						<div class="col-lg-6 form-group">
							<label>Personas que Residen</label> <input type="text"
								placeholder="" class="form-control">
						</div>
						<div class="col-lg-6 form-group">
							<label>Departamento</label> <input type="text" placeholder=""
								class="form-control">
						</div>
					</div>
					<div class="row">
						<div class="col-lg-6 form-group">
							<label>Estacionamiento</label> <input type="text" placeholder=""
								class="form-control">
						</div>
						<div class="col-lg-6 form-group">
							<label>Bodega</label> <input type="text" placeholder=""
								class="form-control">
						</div>
					</div>
